...
public class SellerFormController implements Initializable{
	...
	private void initializeNodes() {
		...
		Constraints.setTextFieldMaxLength(txtName, 70); //maximo de 30 caracteres
		Constraints.setTextFieldDouble(txtBaseSalary); //campo double
		Constraints.setTextFieldMaxLength(txtEmail, 90);
		Utils.formatDatePicker(dpBirthDate, "dd/MM/yyyy"); //formato da data de nascimento
	}
